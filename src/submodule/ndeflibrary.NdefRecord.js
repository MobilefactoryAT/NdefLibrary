...
function initLibraryNdefRecord (context) {
  ...
  var ndefrecord = NdefLibrary.NdefRecord = function(opt_config) {
	...
	/// </summary>
	this.typeNameFormat = NdefLibrary.NdefRecord.TypeNameFormatType.Empty;
	...
	/// Indicates the structure of the value of the TYPE field.
	/// </summary>
  	this.setTypeNameFormat = function(tnf) {
  		this.typeNameFormat = tnf;
  	};
	
  	/// <summary>
      /// Indicates the structure of the value of the TYPE field.
      /// </summary>
      this.getTypeNameFormat = function() {
      ...
      this.checkSpecializedType = function(checkForSubtypes) {
          //TODO return current type
      };
      ...
      this.checkIfValid = function() {
          ...
          if (this.typeNameFormat == NdefLibrary.NdefRecord.TypeNameFormatType.Unchanged ||
              this.typeNameFormat == NdefLibrary.NdefRecord.TypeNameFormatType.Unknown)
          {
          ...
          else
          {
              ...
              if (this.typeNameFormat != NdefLibrary.NdefRecord.TypeNameFormatType.Empty && (this._type == null || this._type.length == 0))
              {
          ...
          if (this.typeNameFormat == NdefLibrary.NdefRecord.TypeNameFormatType.Unchanged && !(this._id == null || this._id.length == 0))
      ...
      if (arguments.length == 2) {
          ...
          this.typeNameFormat = arguments[0];
          if (arguments[1] != null){
      	...
      	this.typeNameFormat = other.getTypeNameFormat();
      } 
      else {
